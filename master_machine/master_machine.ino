...
int timeReceived = 0;
volatile int timeReceivedRight = 0;  
int data;
...
void loop() {
  ...
  if (shouldReadRight) {
    ...
    if (A1 <= currentTimeStep && A2 > currentTimeStep) {
      ...
      Serial.print("out of sync right ");
      Serial.println(currentTimeStep);
    }
    shouldReadRight = false;
  }
...
/////////////////////////////
// scoring machine logic
// TODO: fix simultaneous touch
////////////////////////////
